...
{                                                                                                  }
{ 2014-02-02 Modified by Zvezdan Dimitrijevic for use with TPerlRegEx with PCRE_UCP and PCRE_16    }
{**************************************************************************************************}
{                                                                                                  }
...
{$LINK pcre\win32\pcre_compile.obj}
{$LINK pcre\win32\pcre_config.obj}
{$LINK pcre\win32\pcre_dfa_exec.obj}
{$LINK pcre\win32\pcre_exec.obj}
{$LINK pcre\win32\pcre_fullinfo.obj}
{$LINK pcre\win32\pcre_get.obj}
{$LINK pcre\win32\pcre_jit_compile.obj}
{$LINK pcre\win32\pcre_maketables.obj}
{$LINK pcre\win32\pcre_newline.obj}
{$LINK pcre\win32\pcre_ord2utf8.obj}
{$LINK pcre\win32\pcre_refcount.obj}
{$LINK pcre\win32\pcre_study.obj}
{$LINK pcre\win32\pcre_tables.obj}
{$LINK pcre\win32\pcre_ucd.obj}
{$LINK pcre\win32\pcre_valid_utf8.obj}
{$LINK pcre\win32\pcre_version.obj}
{$LINK pcre\win32\pcre_xclass.obj}
{$LINK pcre\win32\pcre_chartables.obj}

{$ENDIF PCRE_8}

{$IFDEF PCRE_16}

{$LINK pcre\win32\pcre16_compile.obj}
{$LINK pcre\win32\pcre16_config.obj}
{$LINK pcre\win32\pcre16_dfa_exec.obj}
{$LINK pcre\win32\pcre16_exec.obj}
{$LINK pcre\win32\pcre16_fullinfo.obj}
{$LINK pcre\win32\pcre16_get.obj}
{$LINK pcre\win32\pcre16_jit_compile.obj}
{$LINK pcre\win32\pcre16_maketables.obj}
{$LINK pcre\win32\pcre16_newline.obj}
{$LINK pcre\win32\pcre16_ord2utf16.obj}
{$LINK pcre\win32\pcre16_refcount.obj}
{$LINK pcre\win32\pcre16_study.obj}
{$LINK pcre\win32\pcre16_tables.obj}
{$LINK pcre\win32\pcre16_ucd.obj}
{$LINK pcre\win32\pcre16_valid_utf16.obj}
{$LINK pcre\win32\pcre16_version.obj}
{$LINK pcre\win32\pcre16_xclass.obj}
{$LINK pcre\win32\pcre16_chartables.obj}
{$LINK pcre\win32\pcre16_string_utils.obj}
{$ENDIF PCRE_16}
...
{$LINK pcre\win64\pcre_compile.obj}
{$LINK pcre\win64\pcre_config.obj}
{$LINK pcre\win64\pcre_dfa_exec.obj}
{$LINK pcre\win64\pcre_exec.obj}
{$LINK pcre\win64\pcre_fullinfo.obj}
{$LINK pcre\win64\pcre_get.obj}
{$LINK pcre\win64\pcre_jit_compile.obj}
{$LINK pcre\win64\pcre_maketables.obj}
{$LINK pcre\win64\pcre_newline.obj}
{$LINK pcre\win64\pcre_ord2utf8.obj}
{$LINK pcre\win64\pcre_refcount.obj}
{$LINK pcre\win64\pcre_study.obj}
{$LINK pcre\win64\pcre_tables.obj}
{$LINK pcre\win64\pcre_ucd.obj}
{$LINK pcre\win64\pcre_valid_utf8.obj}
{$LINK pcre\win64\pcre_version.obj}
{$LINK pcre\win64\pcre_xclass.obj}
{$LINK pcre\win64\pcre_chartables.obj}

{$ENDIF PCRE_8}

{$IFDEF PCRE_16}

{$LINK pcre\win64\pcre16_compile.obj}
{$LINK pcre\win64\pcre16_config.obj}
{$LINK pcre\win64\pcre16_dfa_exec.obj}
{$LINK pcre\win64\pcre16_exec.obj}
{$LINK pcre\win64\pcre16_fullinfo.obj}
{$LINK pcre\win64\pcre16_get.obj}
{$LINK pcre\win64\pcre16_jit_compile.obj}
{$LINK pcre\win64\pcre16_maketables.obj}
{$LINK pcre\win64\pcre16_newline.obj}
{$LINK pcre\win64\pcre16_ord2utf16.obj}
{$LINK pcre\win64\pcre16_refcount.obj}
{$LINK pcre\win64\pcre16_study.obj}
{$LINK pcre\win64\pcre16_tables.obj}
{$LINK pcre\win64\pcre16_ucd.obj}
{$LINK pcre\win64\pcre16_valid_utf16.obj}
{$LINK pcre\win64\pcre16_version.obj}
{$LINK pcre\win64\pcre16_xclass.obj}
{$LINK pcre\win64\pcre16_chartables.obj}
{$LINK pcre\win64\pcre16_string_utils.obj}
...
begin
{$IFDEF PCRE_8}
  if pattern <> nil then pcre_free_jcl(pattern);
  if hints <> nil then pcre_free_jcl(hints);
  if chartable <> nil then pcre_free_jcl(chartable);
{$ENDIF PCRE_8}
{$IFDEF PCRE_16}
  if pattern <> nil then pcre16_free_jcl(pattern);
  if hints <> nil then pcre16_free_jcl(hints);
  if chartable <> nil then pcre16_free_jcl(chartable);
{$ENDIF PCRE_16}
end;
{$ENDIF PCRE_STATICLINK}
