...
var
  _SMsgDlgWarning: Widestring;
  _SMsgDlgConfirm: Widestring;
  _SMsgDlgYes, _SMsgDlgNo, _SMsgDlgOK, _SMsgDlgCancel, _SMsgDlgAll,
  _SMsgDlgYesToAll, _SMsgDlgNoToAll
  : WideString;
...
begin
  case MsgType of
    mtWarning:      Result := _SMsgDlgWarning;
    mtError:        Result := SMsgDlgError;
    mtInformation:  Result := SMsgDlgInformation;
    mtConfirmation: Result := _SMsgDlgConfirm;
    mtCustom:       Result := '';
    else
...
begin
  case MsgDlgBtn of
    mbYes:         Result := _SMsgDlgYes;
    mbNo:          Result := _SMsgDlgNo;
    mbOK:          Result := _SMsgDlgOK;
    mbCancel:      Result := _SMsgDlgCancel;
    mbAbort:       Result := SMsgDlgAbort;
    mbRetry:       Result := SMsgDlgRetry;
    mbIgnore:      Result := SMsgDlgIgnore;
    mbAll:         Result := _SMsgDlgAll;
    mbNoToAll:     Result := _SMsgDlgNoToAll;
    mbYesToAll:    Result := _SMsgDlgYesToAll;
