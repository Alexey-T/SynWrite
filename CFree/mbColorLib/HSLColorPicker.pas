...
type
 ...
 private
  ...
  function GetWebSafe: boolean;
  procedure SetWebSafe(V: boolean);
 protected
 ...
 public
  ...
  property WebSafe: boolean read GetWebSafe write SetWebSafe default false;
...
function THSLColorPicker.GetWebSafe: boolean;
begin
  Result := FHSPicker.WebSafe;
end;

procedure THSLColorPicker.SetWebSafe(V: boolean);
begin
  FHSPicker.WebSafe := V;
end;
