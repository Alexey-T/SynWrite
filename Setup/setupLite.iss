...
Source: "..\Readme\*.txt"; DestDir: "{app}\Readme"; Flags: ignoreversion
Source: "..\Readme\SynWrite*.chm"; DestDir: "{app}\Readme"; Flags: ignoreversion
...
;Source: "..\Tools\ColorPicker.exe"; DestDir: "{app}\Tools"; Flags: ignoreversion
Source: "..\Tools\HtmlHelpView.exe"; DestDir: "{app}\Tools"; Flags: ignoreversion
Source: "..\Tools\ImageToBmp.exe"; DestDir: "{app}\Tools"; Flags: ignoreversion
Source: "..\Tools\Lorem.txt"; DestDir: "{app}\Tools"; Flags: ignoreversion
Source: "..\Dictionaries\*"; DestDir: "{app}\Dictionaries"; Flags: ignoreversion
Source: "..\Syn.sample.ini"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\SynHide.sample.ini"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Portable-.ini"; DestName: "Portable.ini"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\SynWrite Lite"; Filename: "{app}\Syn.exe"
Name: "{group}\SynWrite Help"; Filename: "{app}\Readme\SynWrite.chm"
Name: "{group}\{cm:UninstallProgram,SynWrite Lite}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\SynWrite Lite"; Filename: "{app}\Syn.exe"; Tasks: desktopicon
