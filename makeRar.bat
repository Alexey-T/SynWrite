...
rem SynWrite.rar
start /min /wait winrar a %a% *.wlx *.inf Syn.exe SynHelper.exe LexLib.lxl Enc.cfg Lexers.cfg HL\* Readme\* Lang\* Data\autocomplete\* Data\colors\* Data\newdoc\* Data\outpresets\* Data\skins\* Data\conv\* Data\icons\* Data\htmltidy\* Data\websearch\* Tools\* Dictionaries\* Plugins\Explorer\* Plugins\SynFTP\* SynPlugins.sample.ini *.dll python3*.* *.manifest DLLs\* Py\sw*.py
start /min /wait winrar a %a% Data\snippets\Std.C Data\snippets\Std.Pascal Data\snippets\Std.Python Data\snippets\Std.Java Data\snippets\Std.Php Py\syn_plugin_manager\*.py Py\syn_plugin_manager\*.lng Py\syn_plugin_manager\*.inf
