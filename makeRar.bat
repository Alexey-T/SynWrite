...
rem SynWrite.rar
start /min /wait winrar a %a% *.wlx *.inf Syn.exe Enc.cfg Lexers.cfg Tidy.cfg HL\* Readme\* Lang\* Template\colors\* Template\newdoc\* Template\tools\* Template\clips\* Template\skins\* Template\conv\* "Template\icons\Tango 22x22\*" "Template\icons\Fugue 16x16\*" "Template\icons\Fugue 24x24\*" Tools\* Dictionaries\* Plugins\Explorer\* Plugins\SynFTP\* SynPlugins.sample.ini *.dll python3*.* *.manifest DLLs\* Py\sw*.py
