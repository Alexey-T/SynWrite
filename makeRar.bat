...
rem SynWrite.rar
start /min /wait winrar a %a% *.wlx *.inf Syn.exe SynHelper.exe LexLib.lxl Enc.cfg Lexers.cfg HL\* Readme\* Lang\* Data\autocomplete\* Data\colors\* Data\newdoc\* Data\outpresets\* Data\skins\* Data\conv\* Data\icons\* Data\htmltidy\* Tools\* Dictionaries\* Plugins\Explorer\* Plugins\SynFTP\* SynPlugins.sample.ini *.dll python3*.* *.manifest DLLs\* Py\sw*.py
