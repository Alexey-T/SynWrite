...
start /min /wait winrar a %a% Data\snippets\Std.C Data\snippets\Std.Pascal Data\snippets\Std.Php Py\syn_plugin_manager\*.py Py\syn_plugin_manager\*.lng Py\syn_plugin_manager\*.inf
