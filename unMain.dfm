  ...
  object TBXDockLeft: TSpTBXMultiDock
    ...
    object plTree: TSpTBXDockablePanel
      ...
      object tbTabsLeft: TSpTBXTabSet
        ...
        HiddenItems = <>
        object TbxTabTree: TSpTBXTabItem
          Caption = 'Tree'
          OnClick = TBXItemLeftTreeClick
        end
        object TbxTabProject: TSpTBXTabItem
          Caption = 'Project'
          Checked = True
          OnClick = TBXItemLeftProjClick
        end
        object TbxTabTabs: TSpTBXTabItem
          Caption = 'Tabs'
  ...
  object TBXDockRight: TSpTBXMultiDock
    ...
    object plClip: TSpTBXDockablePanel
      ...
      object tbTabsRight: TSpTBXTabSet
        ...
        TabPosition = ttpBottom
        HiddenItems = <>
        object TbxTabClipboard: TSpTBXTabItem
          Caption = 'Clipboard'
          Checked = True
          OnClick = TBXItemRightClipClick
        end
        object TbxTabMinimap: TSpTBXTabItem
          Caption = 'Minimap'
          OnClick = TBXItemRightMapClick
        end
        object TbxTabClips: TSpTBXTabItem
          Caption = 'Clips'
